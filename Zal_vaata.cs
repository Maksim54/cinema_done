...
namespace Kinoteatr_bilet
{
    ...
    public partial class Zal_vaata : Form
    {
        ...
        public Zal_vaata(int read, int kohad)
        {
            ...
            for (int r = 0; r < read; r++)
            {
                for (int k = 0; k < kohad; k++)
                {
                    ...
                    {
                        Text = string.Format("Row {0},Place {1}", r + 1, k + 1),
        ...
        private void Saada_piletid(List<Pilet> piletid)
        {
            ...
            {
                MessageBox.Show("Email is missing", "Email");
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Zal_vaata";
            this.Load += new System.EventHandler(this.Zal_vaata_Load);
            this.ResumeLayout(false);

        }

        private void Zal_vaata_Load(object sender, EventArgs e)
        {
        ...
        private void Pileti_zapis(object sender, EventArgs e)
        {
            ...
            var vas = MessageBox.Show("Your ticket is: Row: " + rida + " Place: " + koht, "Do you buy?", MessageBoxButtons.YesNo);
            ...
            if (MessageBox.Show("You bought: " + piletid.Count() + " tickets", "Do you want to send them by e-mail?", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
